...
namespace Browserstack
{
    ...
    public class Excel_ReaderDocSearch : IExcelReadWriter
    {
                ...
                foreach (Cell c in r.Elements<Cell>())
                {
                    if (c.DataType != null && c.DataType == CellValues.SharedString)
                    {
                        ...
                        switch (GetColumnIndex(c.CellReference))
                        {
                            ...
                            case 3:
                                keyValuePairs.Add(new KeyValuePair<string, string>("Step", val));
                                break;

                            case 4:
                                keyValuePairs.Add(new KeyValuePair<string, string>("StepDescription", val));
                                break;

                            case 5:
                                keyValuePairs.Add(new KeyValuePair<string, string>("SearchBy", val));
                                break;
                            ...
                            case 6:
                                ...
                                break;
                            case 7:
                                keyValuePairs.Add(new KeyValuePair<string, string>("ExpetedURL", val));
                                dict.Add(testID, keyValuePairs);
                                break;
                        }
                    }
        ...
        public Dictionary<string, List<KeyValuePair<string, string>>> ReadOutXLS(string fileName)
        {
            //var fileName = @"C:\Temp\TestDataInputs.xlsx";
            this._fileName = fileName;
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("TestId is: "  + kvp.Key.ToString()); //Key
